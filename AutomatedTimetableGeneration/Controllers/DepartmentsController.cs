...
namespace AutomatedTimetableGeneration.Controllers
{
    ...
    public class DepartmentsController : Controller
    {
        ...
        {
            var departments = db.Departments.Include(d => d.AcademicYear);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Capacity,AcademicYear_id,WorkHoursPerDay,AllowedGapHours")] Department department)
        {
            if (ModelState.IsValid)
            {
